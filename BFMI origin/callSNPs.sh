~/Github/bcftools/bcftools mpileup -r 3:31573142-41613389 -I -q 20 -Ou -f /home/danny/References/Mouse/GRCm38_68/GRCm38_68.fa \
...
| ~/Github/bcftools/bcftools call -mv -Ou | ~/Github/bcftools/bcftools filter -i 'MIN(DP)>20 && QUAL>200' -Oz > MGP_BFMI_BBS7_SNPs.vcf.gz