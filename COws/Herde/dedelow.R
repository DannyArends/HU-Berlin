...
ranzigLKV <- read.table("NeuDaten08/TabellePatricia/Dedelow.txt", sep = "\t", header=TRUE)
ranzigLKV[,"Datum"] <- as.Date(ranzigLKV[,"Datum"], "%m/%d/%Y")

D2018_4 <- cbind(F = "2018_4", read.dbf("HerdeSicherungen/dedelow/2018_04/BESTAND.DBF"))
D2017 <- cbind(F = "2017", read.dbf("HerdeSicherungen/dedelow/2017/2017_11/HW_90780040_171107/BESTAND.DBF"))

allD <- rbind(D2018_4, D2017)
...
K2018_4 <- read.dbf("HerdeSicherungen/Dedelow/2018_04/KRANK.DBF")
K2017 <- read.dbf("HerdeSicherungen/Dedelow/2017/2017_11/HW_90780040_171107/KRANK.DBF")

allK <- rbind(K2018_4, K2017)
