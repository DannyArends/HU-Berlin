...
ranzigLKV <- read.table("NeuDaten08/TabellePatricia/Mittenwalde.txt", sep = "\t", header=TRUE)
ranzigLKV[,"Datum"] <- as.Date(ranzigLKV[,"Datum"], "%m/%d/%Y")

D2018_4 <- cbind(F = "2018_4", read.dbf("HerdeSicherungen/Mittenwalde/2018_04/BESTAND.DBF"))
...
K2018_4 <- read.dbf("HerdeSicherungen/Mittenwalde/2018_04/KRANK.DBF")
