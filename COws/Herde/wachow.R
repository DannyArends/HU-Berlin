...
ranzigLKV <- read.table("NeuDaten08/TabellePatricia/wachow.txt", sep = "\t", header=TRUE)
ranzigLKV[,"Datum"] <- as.Date(ranzigLKV[,"Datum"], "%m/%d/%Y")

D2018_4 <- cbind(F = "2018_4", read.dbf("HerdeSicherungen/wachow/2017/2018_04/BESTAND.DBF"))
...
K2017 <- read.dbf("HerdeSicherungen/Wachow/2017/2017_11/HW_91037910_171110/KRANK.DBF")
K2018_4 <- read.dbf("HerdeSicherungen/wachow/2017/2018_04/KRANK.DBF")

allK <- rbind(K2017, K2018_4)
