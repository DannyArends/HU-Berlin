...
referenceDir  <- "~/References/Mouse/GRCm38_68"
reference     <- paste0(referenceDir, "/GRCm38_68.fa")
...
trimmomatic   <- "/home/danny/Github/trimmomatic/trimmomatic-0.36/dist/jar/"
adapters      <- "/home/danny/Github/trimmomatic/trimmomatic-0.36/adapters/TruSeq3-PE.fa"
gatk          <- "/home/danny/Github/GATK-3.7/GenomeAnalysisTK.jar"
picard        <- "/home/danny/Github/picard/build/libs/picard.jar"
...
cmdBase <- paste0("java -jar ", trimmomatic, "trimmomatic-0.36.jar PE")
