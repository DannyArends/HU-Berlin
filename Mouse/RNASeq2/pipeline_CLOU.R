...
sampledescription      <- "/home/lgf/arendsda/experiment/sampledescription.txt"
reference              <- "/work/arendsda/genomes/mm10/Mus_musculus.GRCm38.dna"
...
transcriptome.index    <- "/work/arendsda/genomes/mm10/tophat2/Mus_musculus.GRCm38.genes"
reference.snps         <- "/work/arendsda/genomes/mm10/mgp.v5.merged.snps_all.dbSNP142.vcf.gz"          # wget ftp://ftp-mouse.sanger.ac.uk/current_snps/mgp.v5.merged.snps_all.dbSNP142.vcf.gz
reference.indels       <- "/work/arendsda/genomes/mm10/mgp.v5.merged.indels.dbSNP142.normed.vcf.gz"     # wget ftp://ftp-mouse.sanger.ac.uk/current_snps/mgp.v5.merged.indels.dbSNP142.normed.vcf.gz
reference.gtf          <- "/work/arendsda/genomes/mm10/Mus_musculus.GRCm38.81.gtf"                      # wget ftp://ftp.ensembl.org/pub/release-81/gtf/mus_musculus/Mus_musculus.GRCm38.81.gtf.gz
indels.intervals       <- "/work/arendsda/genomes/mm10/output.indels.intervals"

picarddict.exec        <- "~/bin/jre1.7.0_80/bin/java -Xmx4g -jar /home/lgf/arendsda/bin/picard-tools-1.99/CreateSequenceDictionary.jar"
picardrmdup.exec       <- "~/bin/jre1.7.0_80/bin/java -Xmx4g -jar /home/lgf/arendsda/bin/picard-tools-1.99/MarkDuplicates.jar"
picardrg.exec          <- "~/bin/jre1.7.0_80/bin/java -Xmx4g -jar /home/lgf/arendsda/bin/picard-tools-1.99/AddOrReplaceReadGroups.jar"
picardreo.exec         <- "~/bin/jre1.7.0_80/bin/java -Xmx4g -jar /home/lgf/arendsda/bin/picard-tools-1.99/ReorderSam.jar"
gatk.exec              <- "~/bin/jre1.7.0_80/bin/java -Xmx16g -jar /home/lgf/arendsda/bin/GATK/GenomeAnalysisTK.jar"
b2build.exec           <- "/home/lgf/arendsda/bin/bowtie2-2.2.6/bowtie2-build"
bowtie2.exec           <- "/home/lgf/arendsda/bin/bowtie2-2.2.6/bowtie2"
samtools.exec          <- "/home/lgf/arendsda/bin/samtools-1.2/samtools"
tabix.exec             <- "/home/lgf/arendsda/bin/tabix-0.2.6/tabix"
tophat2.exec           <- "/home/lgf/arendsda/bin//tophat-2.1.0/tophat2"
trimmomatic.exec       <- "~/bin/jre1.7.0_80/bin/java -Xmx8g -jar /home/lgf/arendsda/bin/Trimmomatic-0.32/trimmomatic-0.32.jar"
trimmomatic.adapter    <- "/home/lgf/arendsda/bin/Trimmomatic-0.32/adapters/TruSeq3-PE-2.fa"
