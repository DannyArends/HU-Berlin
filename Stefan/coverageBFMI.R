...
bowtie2 -x /home/arends/RNASeq/Reference/Mus_musculus.GRCm38.dna.bt2idx -1 BFMI_R1.P.fastq.gz -2 BFMI_R2.P.fastq.gz -U BFMI_R1.U.fastq.gz,BFMI_R2.U.fastq.gz -X 2000 -I 50 | samtools view -bS - > BFMIaligned.bam
...
samtools sort -@ 4 -m 2G -o BFMI_aligned.bam BFMI > BFMI_aligned_sorted.bam
